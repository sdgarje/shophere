...
class OrganizationRepository
{
    ...
    public function deleteById($organization_id)
    {
        ...
        $query = $this->query_factory->createQuery(self::TABLE_NAME_PROFILE_FIELDS_DATA, [
            'object_id'   => $organization_id,
            'object_type' => ProfileTypes::CODE_ORGANIZATION
        ]);
    ...
    {
        $query = $this->query_factory->createQuery(self::TABLE_NAME_PROFILE_FIELDS_DATA, [
            'object_id'   => $organization->getOrganizationId(),
            'object_type' => ProfileTypes::CODE_ORGANIZATION
        ]);
        $query->setFields(['value', 'field_id']);

        $organization->setFields($query->column('field_id'));
    }
